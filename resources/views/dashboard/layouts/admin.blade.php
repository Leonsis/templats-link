...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="{{ route('favicon', ['filename' => 'favicon-main.svg']) }}">
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('dashboard.blog') }}" class="menu-item {{ request()->routeIs('dashboard.blog*') ? 'active' : '' }}">
                <i class="fas fa-blog"></i>
                Blog
            </a>
            
            <a href="{{ route('dashboard.leads') }}" class="menu-item {{ request()->routeIs('dashboard.leads*') ? 'active' : '' }}">
