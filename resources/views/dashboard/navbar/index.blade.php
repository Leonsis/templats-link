...
@section('title', 'Configurações da Navbar/Footer')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{ route('dashboard.navbar.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-warning alert-static" data-static="true">
                                    ...
                                    <small class="text-muted">
                                        ...
                                        &lt;img src="{{ \App\Helpers\NavbarHelper::getLogo() }}" alt="Logo"&gt;<br>
                                        <strong>Ou com fallback:</strong><br>
                                        @if(\App\Helpers\NavbarHelper::getLogo())<br>
                                        &nbsp;&nbsp;&lt;img src="{{ \App\Helpers\NavbarHelper::getLogo() }}" alt="Logo"&gt;<br>
                                        @else<br>
                                        &nbsp;&nbsp;&lt;img src="logo-padrao.png" alt="Logo"&gt;<br>
                                        @endif
                                    </small>
                                    @endverbatim
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="logo-preview border rounded p-3 text-center" style="min-height: 120px;">
                                                @if($navbarConfigs->logo)
                                                    <img src="{{ \App\Helpers\HeadHelper::getLogo() }}" 
                                                         alt="Logo atual" 
                                                         class="logo-current" 
                        ...
                        <div class="card shadow border-success">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-warning alert-static" data-static="true">
                                    ...
                                    <small class="text-muted">
                                        <strong>Exemplo de uso:</strong><br>
                                        &lt;img src="{{ \App\Helpers\NavbarHelper::getLogoFooter() }}" alt="Logo Footer"&gt;<br>
                                        <strong>Ou com fallback:</strong><br>
                                        @if(\App\Helpers\NavbarHelper::getLogoFooter())<br>
                                        &nbsp;&nbsp;&lt;img src="{{ \App\Helpers\NavbarHelper::getLogoFooter() }}" alt="Logo Footer"&gt;<br>
                                        @else<br>
                                        &nbsp;&nbsp;&lt;img src="logo-footer-padrao.png" alt="Logo Footer"&gt;<br>
                                        @endif
                                    </small>
                                    @endverbatim
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-warning alert-static" data-static="true">
                                    ...
                                    <small class="text-muted">
                                        ...
                                        &lt;p&gt;{{ \App\Helpers\NavbarHelper::getDescricaoFooter() }}&lt;/p&gt;<br>
                                        &lt;div&gt;{{ \App\Helpers\NavbarHelper::getCopyrightFooter() }}&lt;/div&gt;<br>
                                        <strong>Ou com fallback:</strong><br>
                                        @if(\App\Helpers\NavbarHelper::getDescricaoFooter())<br>
                                        &nbsp;&nbsp;&lt;p&gt;{{ \App\Helpers\NavbarHelper::getDescricaoFooter() }}&lt;/p&gt;<br>
                                        @endif
                                    </small>
                                    @endverbatim
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="4"
                                              placeholder="Digite uma descrição sobre sua empresa, serviços ou missão que aparecerá no footer do site...">{{ $navbarConfigs->descricao_footer ?? '' }}</textarea>
                                    <div class="form-text">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ $navbarConfigs->copyright_footer ?? '' }}"
                        ...
                        <div class="card shadow border-info">
                            ...
                            <div class="card-body">
                                <div class="alert alert-warning alert-static" data-static="true">
                                    ...
                                    <code class="ms-2">{{ \App\Helpers\NavbarHelper::getEndereco() }}</code><br>
                                    <code class="ms-2">{{ \App\Helpers\NavbarHelper::getHorarioAtendimento() }}</code><br>
                                    <small class="text-muted">
                                        <strong>Exemplos de uso:</strong><br>
                                        &lt;a href="mailto:{{ \App\Helpers\NavbarHelper::getEmailContato() }}"&gt;{{ \App\Helpers\NavbarHelper::getEmailContato() }}&lt;/a&gt;<br>
                                        &lt;a href="tel:{{ \App\Helpers\NavbarHelper::getTelefone() }}"&gt;{{ \App\Helpers\NavbarHelper::getTelefone() }}&lt;/a&gt;<br>
                                        &lt;a href="https://wa.me/{{ \App\Helpers\NavbarHelper::getWhatsapp() }}"&gt;WhatsApp&lt;/a&gt;<br>
                                        &lt;p&gt;{{ \App\Helpers\NavbarHelper::getEndereco() }}&lt;/p&gt;<br>
                                        &lt;p&gt;{{ \App\Helpers\NavbarHelper::getHorarioAtendimento() }}&lt;/p&gt;<br>
                                        <strong>Ou com fallback:</strong><br>
                                        @if(\App\Helpers\NavbarHelper::getEmailContato())<br>
                                        &nbsp;&nbsp;&lt;a href="mailto:{{ \App\Helpers\NavbarHelper::getEmailContato() }}"&gt;{{ \App\Helpers\NavbarHelper::getEmailContato() }}&lt;/a&gt;<br>
                                        @endif
                                    </small>
                                    @endverbatim
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" 
                                                   ...
                                                   id="email_contato" 
                                                   name="email_contato" 
                                                   value="{{ $navbarConfigs->email_contato ?? '' }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{{ $navbarConfigs->horario_atendimento ?? '' }}"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" 
                                                      ...
                                                      name="endereco" 
                                                      rows="3"
                                                      placeholder="Rua, Número, Bairro, Cidade - Estado, CEP">{{ $navbarConfigs->endereco ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card shadow border-warning">
                            ...
                            <div class="card-body">
                                <div class="alert alert-warning alert-static" data-static="true">
                                    ...
                                    <code class="ms-2">{{ \App\Helpers\NavbarHelper::getGithub() }}</code><br>
                                    <small class="text-muted">
                                        <strong>Exemplos de uso:</strong><br>
                                        &lt;a href="{{ \App\Helpers\NavbarHelper::getFacebook() }}" target="_blank"&gt;Facebook&lt;/a&gt;<br>
                                        &lt;a href="{{ \App\Helpers\NavbarHelper::getInstagram() }}" target="_blank"&gt;Instagram&lt;/a&gt;<br>
                                        <strong>Ou com fallback:</strong><br>
                                        @if(\App\Helpers\NavbarHelper::getFacebook())<br>
                                        &nbsp;&nbsp;&lt;a href="{{ \App\Helpers\NavbarHelper::getFacebook() }}" target="_blank"&gt;Facebook&lt;/a&gt;<br>
                                        @endif
                                    </small>
                                    @endverbatim
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control" id="facebook" name="facebook" value="{{ $navbarConfigs->facebook ?? '' }}" placeholder="https://facebook.com/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control" id="instagram" name="instagram" value="{{ $navbarConfigs->instagram ?? '' }}" placeholder="https://instagram.com/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control" id="twitter" name="twitter" value="{{ $navbarConfigs->twitter ?? '' }}" placeholder="https://twitter.com/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control" id="linkedin" name="linkedin" value="{{ $navbarConfigs->linkedin ?? '' }}" placeholder="https://linkedin.com/company/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control"  id="youtube" name="youtube" value="{{ $navbarConfigs->youtube ?? '' }}" placeholder="https://youtube.com/c/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control"  id="github" name="github" value="{{ $navbarConfigs->github ?? '' }}" placeholder="https://github.com/empresa">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function loadImageGallery() {
    ...
    fetch('{{ route("dashboard.navbar.images") }}')
