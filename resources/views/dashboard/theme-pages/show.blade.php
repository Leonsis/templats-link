                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <small class="text-muted">
                                                        Criado em: {{ \Carbon\Carbon::parse($formulario->created_at)->format('d/m/Y H:i') }}
                                                        @if($formulario->updated_at != $formulario->created_at)
                                                            | Atualizado em: {{ \Carbon\Carbon::parse($formulario->updated_at)->format('d/m/Y H:i') }}
                                                        @endif
                                                    </small>
                                                </div>
                                                <div class="btn-group">
                                                    <a href="{{ route('dashboard.theme-pages.content-form.edit', [$pagina, $formulario->id]) }}" 
                                                    class="btn btn-primary btn-sm">
                                                        <i class="fas fa-edit me-1"></i>Editar
                                                    </a>
                                                    <form action="{{ route('dashboard.theme-pages.content-form.destroy', [$pagina, $formulario->id]) }}" 
                                                        method="POST" 
                                                        class="d-inline"
                        ...
                        <div class="d-flex justify-content-center gap-3 flex-wrap">
                            <form action="{{ route('dashboard.theme-pages.content-form.allocate-classes', $pagina) }}" method="POST" class="d-inline" onsubmit="return confirm('Isso irá adicionar automaticamente a classe \"con\" às tags com conteúdo no arquivo HTML. Deseja continuar?')">
                                @csrf
                            ...
                            <form action="{{ route('dashboard.theme-pages.content-form.create', $pagina) }}" method="POST" class="d-inline">
                                @csrf
