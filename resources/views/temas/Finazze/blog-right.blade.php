            ...
            <div class="col-lg-8">
                <div class="blog-main-detailsarea rightpadding">
                    ...
                    <ul class="list-author">
                        <li><a href="blog-right.html#"><img src="{{ asset('temas/Finazze/assets/img/all-images/blog/blog-img21.png') }}"" alt=""> Adil Rashid <span> | </span></a></li>
                        <li><a href="blog-right.html#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <div class="tags-social">
                        <div class="tags">
                            <ul>
                                <li>Our Tags:</li>
                                <li><a href="blog-right.html#">Finance</a></li>
                                <li><a href="blog-right.html#">Development</a></li>
                                <li><a href="blog-right.html#" class="m-0">Creative</a></li>
                            </ul>
                        </div>
                        <div class="social">
                            <ul>
                                <li>Share:</li>
                                <li><a href="blog-right.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                                <li><a href="blog-right.html#"><i class="fa-brands fa-instagram"></i></a></li>
                                <li><a href="blog-right.html#" class="m-0"><i class="fa-brands fa-youtube"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="space32"></div>
                        ...
                        <div class="comments-boxes">
                          <div class="comments-auhtor-box">
                            ...
                            <div class="content">
                              ...
                              <a href="blog-right.html#" class="date"> 8 December 2025</a>
                            </div>
                          </div>
                          <a href="blog-right.html#" class="reply"><i class="fa-solid fa-reply"></i> Reply</a>
                        </div>
                        <div class="space16"></div>
                        ...
                        <div class="comments-boxes">
                          <div class="comments-auhtor-box">
                            ...
                            <div class="content">
                              ...
                              <a href="blog-right.html#" class="date"> 12 May 2025</a>
                            </div>
                          </div>
                          <a href="blog-right.html#" class="reply"><i class="fa-solid fa-reply"></i> Reply</a>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="blog-side-widget">
                    ...
                    <div class="categories-area">
                        ...
                        <div class="space4"></div>
                        <ul>
                            <li><a href="blog-right.html#">Supply Chain Management <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                            <li><a href="blog-right.html#">Mergers And Acquisitions <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                            <li><a href="blog-right.html#">Investment Strategies <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                            <li><a href="blog-right.html#">Wealth Management <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                            <li><a href="blog-right.html#">Transformation in Finance <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                        </ul>
                    </div>
                    <div class="space30"></div>
                    <div class="recent-posts-area">
                        ...
                        <div class="recent-posts">
                            ...
                            <div class="content">
                                <ul>
                                    <li><a href="blog-right.html#"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="14" viewBox="0 0 12 14" fill="none">
                    ...
                    <div class="popular-tags">
                        ...
                        <div class="space8"></div>
                        <ul>
                            <li><a href="blog-right.html#">Financial Success</a></li>
                            <li><a href="blog-right.html#">Business Growth</a></li>
                        </ul>

                        <ul>
                            <li><a href="blog-right.html#">Strategic Planning</a></li>
                            <li><a href="blog-right.html#">Management</a></li>
                        </ul>
                        <ul>
                            <li><a href="blog-right.html#">Flow Solutions</a></li>
                            <li><a href="blog-right.html#">Tax Optimization</a></li>
                        </ul>
                    </div>
                    <div class="space30"></div>
                    <div class="author-area">
                        ...
                        <div class="space24"></div>
                        <ul>
                            <li><a href="blog-right.html#"><img src="{{ asset('temas/Finazze/assets/img/all-images/blog/blog-img20.png') }}"" alt=""></a></li>
                            <li><a href="blog-right.html#"><img src="{{ asset('temas/Finazze/assets/img/all-images/blog/blog-img21.png') }}"" alt=""></a></li>
                            <li><a href="blog-right.html#"><img src="{{ asset('temas/Finazze/assets/img/all-images/blog/blog-img22.png') }}"" alt=""></a></li>
                            <li><a href="blog-right.html#"><img src="{{ asset('temas/Finazze/assets/img/all-images/blog/blog-img23.png') }}"" alt=""></a></li>
                        </ul>
                    </div>
                    <div class="space30"></div>
                    <div class="social-area">
                        ...
                        <ul>
                            <li><a href="blog-right.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a href="blog-right.html#"><i class="fa-brands fa-instagram"></i></a></li>
                            <li><a href="blog-right.html#"><i class="fa-brands fa-pinterest-p"></i></a></li>
                            <li><a href="blog-right.html#"><i class="fa-brands fa-linkedin-in"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
          ...
          <div class="vl-blog-1-item">
             ...
             <div class="vl-blog-1-content">
              <div class="vl-blog-meta">
                 <ul>
                  <li>
                    <a href="blog-right.html#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
                  ...
                  <li>
                    <a href="blog-right.html#"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
