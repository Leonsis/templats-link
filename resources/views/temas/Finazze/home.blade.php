        ...
        <div class="service-single-slider owl-carousel">
          <div class="service-boxarea">
            <div class="img1">
              ...
              <div class="arrow">
                <a href="{{ route('tema.Finazze.service-single') }}"><i class="fa-solid fa-arrow-right"></i></a>
              </div>
            </div>
          ...
          <div class="service-boxarea">
            ...
            <div class="content-area">
              ...
              <div class="space24"></div>
              <a href="{{ route('tema.Finazze.service-single') }}">Budgeting And Forecasting </a>
            </div>
          </div>
          ...
          <div class="service-boxarea">
            ...
            <div class="content-area">
              ...
              <div class="space24"></div>
              <a href="{{ route('tema.Finazze.service-single') }}">Financial Growth</a>
            </div>
          </div>
          <div class="service-boxarea">
            <div class="img1">
            ...
            <div class="content-area">
              ...
              <div class="space24"></div>
              <a href="{{ route('tema.Finazze.service-single') }}">Mergers & Acquisitions </a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="project-single-boxarea">
          <div class="project-boxarea heading1">
            ...
            <div class="space16"></div>
            <h2><a href="{{ route('tema.Finazze.project-single') }}">The Empowerment Project Financial Freedom for All</a></h2>
            <div class="space16"></div>
            ...
            <div class="space24"></div>
            <a href="{{ route('tema.Finazze.project-single') }}">Read More <i class="fa-solid fa-arrow-right"></i></a>
          </div>
              ...
              <div class="space16"></div>
                ...
                <div class="verical-boxarea">
                  <div class="images-area">
                    ...
                    <div class="text">
                        <a href="{{ route('tema.Finazze.team') }}">Alexy Queen</a>
                        <p>Happy Client</p>
                    </div>
                </div>
      ...
      <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1000">
        <div class="history-single-slider owl-carousel">
          <div class="history-boxarea">
            ...
            <span></span>
            <div class="space32"></div>
            <a href="{{ route('tema.Finazze.project-single') }}">Founder In London</a>
          ...
          <div class="history-boxarea">
            ...
            <span></span>
            <div class="space32"></div>
            <a href="{{ route('tema.Finazze.project-single') }}">Opening New Office</a>
            <div class="space12"></div>
          ...
          <div class="history-boxarea">
            ...
            <span></span>
            <div class="space32"></div>
            <a href="{{ route('tema.Finazze.project-single') }}">Famous In Town</a>
            <div class="space12"></div>
          ...
          <div class="history-boxarea">
            ...
            <span></span>
            <div class="space32"></div>
            <a href="{{ route('tema.Finazze.project-single') }}">Business Growth</a>
            <div class="space12"></div>
