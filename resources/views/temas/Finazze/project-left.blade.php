            ...
            <div class="col-lg-4">
                <div class="project-side-widget">
                    ...
                    <div class="popular-tags">
                        ...
                        <ul>
                            <li><a href="project-left.html#">Financial Success</a></li>
                            <li><a href="project-left.html#">Business Growth</a></li>
                        </ul>

                        <ul>
                            <li><a href="project-left.html#">Strategic Planning</a></li>
                            <li><a href="project-left.html#">Management</a></li>
                        </ul>
                        <ul>
                            <li><a href="project-left.html#">Flow Solutions</a></li>
                            <li><a href="project-left.html#">Tax Optimization</a></li>
                        </ul>
                    </div>
                    <div class="space30"></div>
                    <div class="help-area">
                    ...
                    <div class="social-area">
                        ...
                        <div class="space24"></div>
                        <ul>
                            <li><a href="project-left.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a href="project-left.html#"><i class="fa-brands fa-instagram"></i></a></li>
                            <li><a href="project-left.html#"><i class="fa-brands fa-pinterest-p"></i></a></li>
                            <li><a href="project-left.html#"><i class="fa-brands fa-linkedin-in"></i></a></li>
                        </ul>
                    </div>
                    <div class="space30"></div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800">
          <div class="project-single-boxarea2">
            ...
            <div class="content-area">
              <div class="text">
                <a href="project-left.html#">#Business And Finance</a>
                <div class="space16"></div>
