            ...
            <div class="col-lg-4">
                <div class="service-side-widget">
                    ...
                    <div class="categories-area">
                        ...
                        <ul>
                            <li><a href="service-right.html#">Supply Chain Management <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                            <li><a href="service-right.html#">Mergers And Acquisitions <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                            <li><a href="service-right.html#">Investment Strategies <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                            <li><a href="service-right.html#">Wealth Management <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                            <li><a href="service-right.html#">Transformation in Finance <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                        </ul>
                    </div>
                    <div class="space30"></div>
                    <div class="help-area">
                    ...
                    <div class="social-area">
                        ...
                        <div class="space24"></div>
                        <ul>
                            <li><a href="service-right.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a href="service-right.html#"><i class="fa-brands fa-instagram"></i></a></li>
                            <li><a href="service-right.html#"><i class="fa-brands fa-pinterest-p"></i></a></li>
                            <li><a href="service-right.html#"><i class="fa-brands fa-linkedin-in"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
