...
<main class="main-wrapper">
                            ...
                            <div class="header1_content-left">
                                <div class="margin-bottom margin-small">
                                    <h1 class="heading-style-h1">
                                        Bem-vindo à Lumiauto: Excelência em Serviços Automotivos
                                    </h1>
                                </div>
                                <p class="text-size-medium">
                                    Na Lumiauto, oferecemos serviços de Martelinho de Ouro, Mecânica Geral, Lanternagem e Pintura com qualidade e agilidade. Confie em nossa equipe para devolver ao seu carro o desempenho e a estética de fábrica.
                                </p>
                                <div class="margin-top margin-medium">
                                    <div class="button-group">
                                        <a href="#!" onclick="openWhatsAppModal()" class="button w-button">Saiba Mais</a>
                                        <a href="http://localhost/templats-link/public/contato" class="button is-secondary w-button">Contato</a>
                                    </div>
                                </div>
                            </div>
                            <div class="header1_image-wrapper">
                                <img sizes="(max-width: 2048px) 100vw, 2048px" srcset="
                                                    images/relume-291627-p-500.jpeg   500w,
                                                    images/relume-291627-p-800.jpeg   800w,
                                                    images/relume-291627-p-1080.jpeg 1080w,
                                                    images/relume-291627-p-1600.jpeg 1600w,
                                                    images/relume-291627-p-2000.jpeg 2000w,
                                                    images/relume-291627.jpeg        2048w
                                                " alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291627.jpeg') }}"" loading="eager" class="header1_image" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="section_layout253 color-scheme-4" style=" background-color: #b2b2b2;">
        <div class="padding-global">
            <div class="container-large">
                <div class="padding-section-large">
                    <div class="layout253_component">
                        <div class="w-layout-grid layout253_content">
                            <div class="layout253_content-left">
                                <div class="margin-bottom margin-small">
                                    <h2 class="heading-style-h2 text-size-medium">
                                        Nossos Serviços de Qualidade para Seu Veículo
                                    </h2>
                                </div>
                                <p class="text-size-medium">
                                    Na Lumiauto, oferecemos serviços que garantem a performance e a estética do seu carro. Conheça nossas especialidades e descubra como podemos cuidar do seu veículo.
                                </p>
                                <div class="margin-top margin-medium">
                                    <div class="button-group">
                                        <a href="#!" onclick="openWhatsAppModal()" class="button is-secondary text-size-medium w-button">Orçamento</a>
                                    </div>
                                </div>
                            </div>
                            <div class="w-layout-grid layout253_list">
                                <div class="layout253_item">
                                    <div class="margin-bottom margin-small">
                                        <div class="layout253_item-icon-wrapper">
                                            <div class="icon-1x1-medium w-embed text-size-medium">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewbox="0 -960 960 960">
                                                            <path fill="currentColor"
                                                                d="M784.76-72.17 622.02-235.91q-12.52 21.8-19.66 45.11-7.14 23.3-9.9 45.34-2.96 13.72-12.56 22.58-9.6 8.86-22.55 8.86-14.2 0-23.92-9.72-9.71-9.72-7.47-22.91 3-34.28 15.62-71.78t32.14-66.03l-41.09-41.08q-25.28 37.52-42.54 81.8-17.26 44.28-21.26 97.09-1.24 14.19-10.82 23.41t-23.53 9.22q-14.2 0-23.41-9.72-9.22-9.72-7.98-22.91 5-63.76 26.24-122.24t56.24-103.72L372.61-485.57q-47.76 36.24-104.74 56.86-56.98 20.62-121.22 25.62-13.19 1.24-22.91-8.09-9.72-9.34-9.72-23.54 0-13.19 9.22-23.03 9.22-9.84 23.41-11.08 51.05-4 96.21-21.14t82.68-42.66l-41.08-41.09q-25.05 18.52-62.79 31.26-37.74 12.74-75.02 16.5-13.19 1.24-22.91-7.97-9.72-9.22-9.72-23.42 0-12.72 8.98-22.67 8.98-9.96 22.93-12.44 26.81-2.76 49.11-10.78 22.31-8.02 41.35-18.78L74.17-783.76q-9.47-9.48-9.47-22.08 0-12.59 9.47-22.07 9.72-9.48 22.58-9.48 12.86 0 22.58 9.48l710.58 709.58q9.24 9.48 9.36 23.2.12 13.72-9.6 22.96-9.47 9.47-22.57 9.35-13.1-.11-22.34-9.35ZM402.89-846.22q13.96 0 23.68 9.84 9.71 9.84 7.47 23.03-5 47.48-21.36 88.34-16.35 40.86-37.59 67.1l-47.07-47.07q14.52-24.28 24.9-50.56 10.38-26.29 14.38-57.81 2.48-13.95 12.44-23.41 9.96-9.46 23.15-9.46Zm122.87 0q13.96 0 23.17 9.84 9.22 9.84 7.98 23.03-5.24 74.44-31.69 134.89-26.46 60.46-62.46 109.22l-47.59-47.83q30.53-37.52 50.76-88.4 20.24-50.88 25.24-107.88 1.48-14.19 10.94-23.53 9.46-9.34 23.65-9.34Zm320.46 320.94q0 13.19-9.34 23.41t-23.53 11.7q-59.76 5.24-106.76 24.35-47 19.12-89.29 49.89l-46.82-46.83q49.24-38.72 108.69-63.82 59.46-25.09 134.18-30.33 13.19-1.24 23.03 8.09 9.84 9.34 9.84 23.54ZM705.98-327.02l-47.83-48.07q31.76-23.24 70.74-38.09 38.98-14.86 84.46-19.86 13.19-2.24 23.03 6.97 9.84 9.22 9.84 23.42 0 13.19-9.46 23.03-9.46 9.84-23.41 12.32-32.52 4-59.69 14.88-27.16 10.88-47.68 25.4Z">
                                                            </path>
                                                        </svg>
                                            </div>
                                        </div>
                                    ...
                                    <div class="margin-bottom margin-small">
                                        <h3 class="heading-style-h4 text-size-medium">
                                            Martelinho de Ouro: Solução Sem Danos
                                        </h3>
                                    </div>
                                    <p class="text-size-medium">
                                        Removemos amassados leves preservando a pintura original.
                                    </p>
                                </div>
                                <div class="layout253_item">
                                    <div class="margin-bottom margin-small">
                                    ...
                                    <div class="margin-bottom margin-small">
                                        <h3 class="heading-style-h4 text-size-medium">
                                            Mecânica Geral: Manutenção Completa do Seu Carro
                                        </h3>
                                    </div>
                                    <p class="text-size-medium">
                                        Oferecemos serviços de mecânica para garantir segurança e desempenho.
                                    </p>
                                </div>
                                <div class="layout253_item">
                                    <div class="margin-bottom margin-small">
                                ...
                                <div class="layout253_item">
                                    ...
                                    <div class="margin-bottom margin-small">
                                        <h3 class="heading-style-h4 text-size-medium">
                                            Entre em Contato e Agende Seu Orçamento
                                        </h3>
                                    </div>
                                    <p class="text-size-medium">
    ...
    <section class="section_testimonial4 color-scheme-1">
        <div class="padding-global">
            <div class="container-large">
                <div class="padding-section-large">
                        ...
                        <div class="testimonial4_component">
                            <div class="testimonial4_content">
                                <div class="margin-bottom margin-medium">
                                    <div class="testimonial4_rating-wrapper">
                                ...
                                <h3 class="heading-style-h5">
                                    &quot;O serviço da Lumiauto superou minhas expectativas! Meu carro ficou como novo e o atendimento foi excepcional.&quot;
                                </h3>
                                <div class="margin-top margin-medium">
                                    <div class="testimonial4_client">
                                        <div class="testimonial4_client-image-wrapper">
                                            <img sizes="(max-width: 1600px) 100vw, 1600px" srcset="
                                                                images/team-8-p-500.jpeg   500w,
                                                                images/team-8-p-800.jpeg   800w,
                                                                images/team-8-p-1080.jpeg 1080w,
                                                                images/team-8.jpeg        1600w
                                                            " alt="" src="{{ asset('temas/Lumialto/assets/images/team-8.jpeg') }}"" loading="eager" class="testimonial4_client-image" />
                                        </div>
                                        <div class="testimonial4_client-info">
    ...
    <section class="section_contact18 color-scheme-5">
        <div class="padding-global">
            <div class="container-large">
                <div class="padding-section-large">
                    <div class="contact18_component">
                        <div class="w-layout-grid contact18_grid-list">
                            <div class="contact18_item">
                                <div class="margin-bottom margin-small">
                                ...
                                <div class="margin-top margin-small">
                                    <a href="mailto:contato@lumiauto.com.br" class="text-style-link">contato@lumiauto.com.br</a>
                                </div>
                            </div>
                            <div class="contact18_item">
                                <div class="margin-bottom margin-small">
                                ...
                                <div class="margin-top margin-small">
                                    <a href="tel:+556130421331" class="text-style-link">(61) 3042-1331</a>
                            ...
                            <div class="contact18_item">
                                ...
                                <div class="margin-top margin-small">
                                    <a href="#" class="text-style-link">SIA Trecho 3 - Guará,
                                                Brasília</a>
                                </div>
                            </div>
                        </div>
