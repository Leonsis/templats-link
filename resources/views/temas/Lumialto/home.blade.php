                    ...
                    <div class="header1_component">
                        <div class="w-layout-grid header1_content">
                            ...
                            <div class="header1_image-wrapper">
                                <img sizes="(max-width: 2048px) 100vw, 2048px" alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291627.jpeg') }}"" loading="eager" class="header1_image" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="margin-top margin-medium">
                                    <div class="testimonial4_client">
                                        <div class="testimonial4_client-image-wrapper">
                                            <img sizes="(max-width: 1600px) 100vw, 1600px" alt="" src="{{ asset('temas/Lumialto/assets/images/team-8.jpeg') }}"" loading="eager" class="testimonial4_client-image" />
                                        </div>
