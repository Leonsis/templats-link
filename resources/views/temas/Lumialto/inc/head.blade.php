<head>
    ...
    <link href="{{ asset('temas/Lumialto/assets/assets/images/fav1.png') }}" rel="shortcut icon" type="image/x-icon">
    <link href="{{ asset('temas/Lumialto/assets/assets/images/webclip.png') }}" rel="apple-touch-icon"><!--  Keep this css code to improve the font quality -->
    <style>
        * {
