<div class="page-wrapper">
    ...
    <div fs-scrolldisable-element="smart-nav" data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="navbar6_component color-scheme-4 w-nav">
        <div class="navbar6_container">
            <a href="/" class="navbar6_logo-link w-nav-brand"><img width="100" sizes="100px" alt="" src="{{ asset('temas/Lumialto/assets/images/LOGO.2-03-1.png') }}" loading="lazy" srcset="assets/images/LOGO.2-03-1-p-500.png 500w, assets/images/LOGO.2-03-1-p-800.png 800w, assets/images/LOGO.2-03-1.png 1080w" class="navbar6_logo"></a>
