<head>
    ...
    @else
        ...
        @endphp
        <title>{{ \App\Helpers\HeadHelper::getMetaTitle($pageName, 'Portfolio') }}</title>
        <meta name="description" content="{{ \App\Helpers\HeadHelper::getMetaDescription($pageName, 'Portfolio') }}">
        <meta name="keywords" content="{{ \App\Helpers\HeadHelper::getMetaKeywords($pageName, 'Portfolio') }}">
    @endif
    ...
    @endphp
    <link rel="preconnect" href="https://{{ $currentDomain }}" crossorigin>
    <link rel="dns-prefetch" href="https://{{ $currentDomain }}">
    ...
    <link rel="preload" href="{{ $normalizeCss }}" as="style" fetchpriority="high">
    <link rel="preload" href="{{ $style }}" as="style" fetchpriority="high">            
    <!-- Preload da imagem do logo (LCP element) com máxima prioridade -->
    @php
        $logoUrl = \App\Helpers\NavbarHelper::getLogo();
    @endphp
    @if($logoUrl)
    <link rel="preload" href="{{ $logoUrl }}" as="image" fetchpriority="high" type="image/webp">
    @endif
    ...
    <link href="{{ asset('temas/Portfolio/assets/images/webclip.png') }}" rel="apple-touch-icon"><!--  Keep this css code to improve the font quality -->
    <!---->
