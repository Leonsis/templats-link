      ...
      <div class="col-lg-3 col-md-6">
        <div class="vl-footer-widget">
          ...
          <ul>
            ...
            <li><a href="team.html#"><img src="{{ asset('temas/finazze/assets/img/icons/location1.svg') }}" alt="">421 Allen, Mexico 4233</a></li>
            ...
            <li><a href="team.html#"><img src="{{ asset('temas/finazze/assets/img/icons/global1.svg') }}" alt="">finazzeconsult.com</a></li>
          </ul>
        </div>
      </div>
