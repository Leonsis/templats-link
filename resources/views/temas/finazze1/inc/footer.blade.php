    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="vl-footer-widget">
          ...
          <h3>Contact Us</h3>
          <ul>
            <li><a href="tel:+11234567890"><img src="{{ asset('temas/finazze1/assets/img/icons/phn1.svg') }}" alt="">+1 123 456 7890</a></li>
            <li><a href="index.html#"><img src="{{ asset('temas/finazze1/assets/img/icons/location1.svg') }}" alt="">421 Allen, Mexico 4233</a></li>
            <li><a href="https://html.vikinglab.agency/finazze/renevagency@com"><img src="{{ asset('temas/finazze1/assets/img/icons/email1.svg') }}" alt="">finazzeconsult@com</a></li>
            <li><a href="index.html#"><img src="{{ asset('temas/finazze1/assets/img/icons/global1.svg') }}" alt="">finazzeconsult.com</a></li>
          </ul>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-4">
              <div class="footer-img">
                <img src="{{ asset('temas/finazze1/assets/img/all-images/footer/footer-img1.png') }}" alt="">
                <div class="icons">
            ...
            <div class="col-lg-4 col-4">
              <div class="footer-img">
                <img src="{{ asset('temas/finazze1/assets/img/all-images/footer/footer-img2.png') }}" alt="">
                <div class="icons">
                  <a href="index.html#"><i class="fa-brands fa-instagram"></i></a>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-4">
              <div class="footer-img">
                <img src="{{ asset('temas/finazze1/assets/img/all-images/footer/footer-img3.png') }}" alt="">
                <div class="icons">
                  <a href="index.html#"><i class="fa-brands fa-instagram"></i></a>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-4">
              <div class="footer-img">
                <img src="{{ asset('temas/finazze1/assets/img/all-images/footer/footer-img4.png') }}" alt="">
                <div class="icons">
                  <a href="index.html#"><i class="fa-brands fa-instagram"></i></a>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-4">
              <div class="footer-img">
                <img src="{{ asset('temas/finazze1/assets/img/all-images/footer/footer-img5.png') }}" alt="">
                <div class="icons">
                  <a href="index.html#"><i class="fa-brands fa-instagram"></i></a>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-4">
              <div class="footer-img">
                <img src="{{ asset('temas/finazze1/assets/img/all-images/footer/footer-img6.png') }}" alt="">
                <div class="icons">
                  <a href="index.html#"><i class="fa-brands fa-instagram"></i></a>
                </div>
              </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="vl-copyright-area">
          <p>{{ \App\Helpers\HeadHelper::getCopyrightFooter() ?: '© Copyright 2025 - finazze1. All Right Reserved' }}</p>
        </div>
      </div>
    </div>
  </div>
