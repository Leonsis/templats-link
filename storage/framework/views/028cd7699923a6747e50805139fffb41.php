...
<head>
    ...
    <?php if($dadosAtuais['favicon']): ?>
        <link rel="icon" type="image/webp" href="<?php echo e(route('favicon', ['filename' => basename($dadosAtuais['favicon'])])); ?>">
    <?php endif; ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/templats-link/resources/views/main-Thema/inc/head.blade.php ENDPATH**/ ?>