                      ...
                      <nav class="vl-mobile-menu-active">
                          <ul>
                              ...
                              <li class="has-dropdown">
                                <a href="service-left.html#">Pages <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                                  <ul class="sub-menu">
                                      ...
                                      <li><a href="<?php echo e(route('tema.finazze.testimonial')); ?>">Testimonials</a></li>
                              ...
                              <li><a href="service-left.html#">Services <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                                <ul class="sub-menu">
                                  <li><a href="<?php echo e(route('tema.finazze.service')); ?>">Our Service</a></li>
                ...
                <div class="vl-hero-btn d-none d-lg-block text-end">
                  <div class="head-btn">
                    <div class="search-icon header__search header-search-btn">
                      <a href="service-left.html#"><img src="<?php echo e(asset('temas/finazze/assets/img/icons/search1.svg')); ?>" alt=""></a>
                    </div>
