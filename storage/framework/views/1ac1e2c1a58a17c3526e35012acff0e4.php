      ...
      <div class="container">
          <div class="row align-items-center">
              <div class="col-lg-2 col-md-6 col-6">
                  <div class="vl-logo">
                      <a href="index.html"><img src="<?php echo e(asset('temas/finazze/assets/img/logo/logo1.png')); ?>" alt=""></a>
                  </div>
              </div>
                ...
                <div class="vl-hero-btn d-none d-lg-block text-end">
                  <div class="head-btn">
                    <div class="search-icon header__search header-search-btn">
                      <a href="index.html#"><img src="<?php echo e(asset('temas/finazze/assets/img/icons/search1.svg')); ?>" alt=""></a>
                    </div>
