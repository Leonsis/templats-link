...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-4">
                                    <label for="meta_description" class="form-label">
                                        ...
                                        <span class="text-muted">(máximo 300 caracteres)</span>
                                    </label>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <div class="form-text">
                                        <span id="description-counter">0</span>/300 caracteres
                                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if($userCanAccessThemes): ?>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <?php if(isset($formularios) && $formularios->count() > 0): ?>
                            <!-- Lista de Formulários Existentes -->
                            <div class="mb-4">
                                <h6 class="mb-3">Formulários Existentes:</h6>
                                    ...
                                    <?php $__currentLoopData = $formularios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formulario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="list-group-item">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    <h6 class="mb-1"><?php echo e($formulario->nome); ?></h6>
                                                    <small class="text-muted">
                                                        Criado em: <?php echo e(\Carbon\Carbon::parse($formulario->created_at)->format('d/m/Y H:i')); ?>

                                                        <?php if($formulario->updated_at != $formulario->created_at): ?>
                                                            | Atualizado em: <?php echo e(\Carbon\Carbon::parse($formulario->updated_at)->format('d/m/Y H:i')); ?>

                                                        <?php endif; ?>
                                                    </small>
                                                </div>
                                                <div class="btn-group">
                                                    <a href="<?php echo e(route('dashboard.theme-pages.content-form.edit', [$pagina, $formulario->id])); ?>" 
                                                    class="btn btn-primary btn-sm">
                                                        <i class="fas fa-edit me-1"></i>Editar
                                                    </a>
                                                    <form action="<?php echo e(route('dashboard.theme-pages.content-form.destroy', [$pagina, $formulario->id])); ?>" 
                                                        method="POST" 
                                                        class="d-inline"
                        ...
                        <?php else: ?>
                            ...
                            <div class="alert alert-warning alert-static mb-4" data-static="true">
                                ...
                                <br><br>
                                <strong>E os conteúdos editáveis devem ter a classe "con":</strong><br>
                                <code class="ms-2">&lt;h1 class="con"&gt;Título&lt;/h1&gt;</code> ou <code class="ms-2">&lt;p class="con"&gt;Texto&lt;/p&gt;</code>
                            </div>
                        <?php endif; ?>
                        
                        <!-- Botões de Formulário de Conteúdo -->
                        <div class="d-flex justify-content-center gap-3 flex-wrap">
                            <form action="<?php echo e(route('dashboard.theme-pages.content-form.allocate-classes', $pagina)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Isso irá adicionar automaticamente a classe \"con\" às tags com conteúdo no arquivo HTML. Deseja continuar?')">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="<?php echo e(route('dashboard.theme-pages.content-form.create', $pagina)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Templats-link-templats-link\resources\views/dashboard/theme-pages/show.blade.php ENDPATH**/ ?>