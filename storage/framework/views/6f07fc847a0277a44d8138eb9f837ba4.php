...
<?php $__env->startSection('title', 'Configurações do Head'); ?>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
                ...
                <div class="col-12">
                    <div class="card shadow border-success">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('dashboard.head.update')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="favicon-preview border rounded p-3 text-center" style="min-height: 100px;">
                                                ...
                                                <?php if($currentFavicon): ?>
                                                    <img src="<?php echo e(\App\Helpers\HeadHelper::getFavicon()); ?>" 
                                                         alt="Favicon atual" 
            ...
            <!-- Lista de Páginas -->
            <div class="row">
                <?php $__currentLoopData = $paginas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paginaKey => $paginaNome): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="alert alert-warning alert-static" data-static="true">
                                    ...
                                    <code class="ms-2">\App\Helpers\HeadHelper::getMetaTitle('<?php echo e($paginaKey); ?>')</code><br>
                                    <code class="ms-2">\App\Helpers\HeadHelper::getMetaDescription('<?php echo e($paginaKey); ?>')</code><br>
                                    <code class="ms-2">\App\Helpers\HeadHelper::getMetaKeywords('<?php echo e($paginaKey); ?>')</code><br>
                                    <small class="text-muted">Adicione as chaves duplas ao redor de cada tag</small>
                                </div>
                                
                                <form action="<?php echo e(route('dashboard.head.update')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="pagina" value="<?php echo e($paginaKey); ?>">
                                    
                                    <!-- Meta Title -->
                                    <div class="mb-3">
                                        <label for="meta_title_<?php echo e($paginaKey); ?>" class="form-label">
                                            <i class="fas fa-tag me-1"></i>
                                            Meta Title
                                        </label>
                                        <input type="text" 
                                               class="form-control" 
                                               id="meta_title_<?php echo e($paginaKey); ?>" 
                                               name="meta_title" 
                                               value="<?php echo e($config->meta_title ?? ''); ?>"
                                               maxlength="60"
                                               placeholder="Título da página (máx. 60 caracteres)">
                                        <div class="form-text">
                                            <span id="title_count_<?php echo e($paginaKey); ?>">0</span>/60 caracteres
                                        </div>
                                    </div>

                                    <!-- Meta Description -->
                                    <div class="mb-3">
                                        <label for="meta_description_<?php echo e($paginaKey); ?>" class="form-label">
                                            <i class="fas fa-align-left me-1"></i>
                                            Meta Description
                                        </label>
                                        <textarea class="form-control" 
                                                  id="meta_description_<?php echo e($paginaKey); ?>" 
                                                  name="meta_description" 
                                                  rows="3"
                                                  maxlength="300"
                                                  placeholder="Descrição da página (máx. 300 caracteres)"><?php echo e($config->meta_description ?? ''); ?></textarea>
                                        <div class="form-text">
                                            <span id="desc_count_<?php echo e($paginaKey); ?>">0</span>/300 caracteres
                                        </div>
                                    </div>

                                    <!-- Meta Keywords -->
                                    <div class="mb-3">
                                        <label for="meta_keywords_<?php echo e($paginaKey); ?>" class="form-label">
                                            <i class="fas fa-key me-1"></i>
                                            Meta Keywords
                                        </label>
                                        <input type="text" 
                                               class="form-control" 
                                               id="meta_keywords_<?php echo e($paginaKey); ?>" 
                                               name="meta_keywords" 
                                               value="<?php echo e($config->meta_keywords ?? ''); ?>"
                                               maxlength="255"
                                               placeholder="Palavras-chave separadas por vírgula (máx. 255 caracteres)">
                                        <div class="form-text">
                                            <span id="keywords_count_<?php echo e($paginaKey); ?>">0</span>/255 caracteres
                                        </div>
                                    </div>
                ...
                <div class="col-12">
                    <div class="card shadow border-warning">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-warning alert-static" data-static="true">
                                <i class="fas fa-code me-2"></i>
                                <strong>Como implementar manualmente:</strong><br>
                                ...
                                <small class="text-muted">
                                    ...
                                    <strong>No &lt;head&gt;:</strong><br>
                                    {!! \App\Helpers\HeadHelper::getGtmHead() !!}<br>
                                    <strong>Após &lt;body&gt;:</strong><br>
                                    {!! \App\Helpers\HeadHelper::getGtmBody() !!}<br>
                                    <strong>Nota:</strong> Use {!! !!} para renderizar HTML sem escape
                                </small>
                            ...
                            <form action="<?php echo e(route('dashboard.head.update')); ?>" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="gtm_body" 
                                              rows="6"
                                              placeholder="Cole aqui o código noscript do Google Tag Manager para o &lt;body&gt;&#10;&#10;Exemplo:&#10;&lt;noscript&gt;&lt;iframe src='https://www.googletagmanager.com/ns.html?id=GTM-XXXXXXX'&#10;height='0' width='0' style='display:none;visibility:hidden'&gt;&lt;/iframe&gt;&lt;/noscript&gt;"><?php echo e($allConfigs->where('pagina', 'global')->first()->gtm_body ?? ''); ?></textarea>
                                    <div class="form-text">
                                        <i class="fas fa-code me-1"></i>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>• Meta Description: até 300 caracteres</li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php $__currentLoopData = $paginas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paginaKey => $paginaNome): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        const titleInput<?php echo e($loop->index); ?> = document.getElementById('meta_title_<?php echo e($paginaKey); ?>');
        const titleCount<?php echo e($loop->index); ?> = document.getElementById('title_count_<?php echo e($paginaKey); ?>');
        
        titleInput<?php echo e($loop->index); ?>.addEventListener('input', function() {
            titleCount<?php echo e($loop->index); ?>.textContent = this.value.length;
            if (this.value.length > 60) {
                titleCount<?php echo e($loop->index); ?>.style.color = 'red';
            } else if (this.value.length > 50) {
                titleCount<?php echo e($loop->index); ?>.style.color = 'orange';
            } else {
                titleCount<?php echo e($loop->index); ?>.style.color = 'green';
            }
        });
        
        // Contador para Meta Description
        const descInput<?php echo e($loop->index); ?> = document.getElementById('meta_description_<?php echo e($paginaKey); ?>');
        const descCount<?php echo e($loop->index); ?> = document.getElementById('desc_count_<?php echo e($paginaKey); ?>');
        
        descInput<?php echo e($loop->index); ?>.addEventListener('input', function() {
            descCount<?php echo e($loop->index); ?>.textContent = this.value.length;
            if (this.value.length > 300) {
                descCount<?php echo e($loop->index); ?>.style.color = 'red';
            } else if (this.value.length > 280) {
                descCount<?php echo e($loop->index); ?>.style.color = 'orange';
            } else {
                descCount<?php echo e($loop->index); ?>.style.color = 'green';
            }
        });
        
        // Contador para Meta Keywords
        const keywordsInput<?php echo e($loop->index); ?> = document.getElementById('meta_keywords_<?php echo e($paginaKey); ?>');
        const keywordsCount<?php echo e($loop->index); ?> = document.getElementById('keywords_count_<?php echo e($paginaKey); ?>');
        
        keywordsInput<?php echo e($loop->index); ?>.addEventListener('input', function() {
            keywordsCount<?php echo e($loop->index); ?>.textContent = this.value.length;
            if (this.value.length > 255) {
                keywordsCount<?php echo e($loop->index); ?>.style.color = 'red';
            } else {
                keywordsCount<?php echo e($loop->index); ?>.style.color = 'green';
            }
        });
        
        // Inicializar contadores
        titleInput<?php echo e($loop->index); ?>.dispatchEvent(new Event('input'));
        descInput<?php echo e($loop->index); ?>.dispatchEvent(new Event('input'));
        keywordsInput<?php echo e($loop->index); ?>.dispatchEvent(new Event('input'));
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
});
</script>
...
function loadImageGallery() {
    ...
    fetch('<?php echo e(route("dashboard.head.images")); ?>')
...
<?php echo $__env->make('dashboard.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Templats-link-templats-link\resources\views/dashboard/head/index.blade.php ENDPATH**/ ?>