                                ...
                                <form action="<?php echo e(route('dashboard.head.update')); ?>" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" 
                                                  ...
                                                  rows="3"
                                                  maxlength="160"
                                                  placeholder="Descrição da página (máx. 160 caracteres)"><?php echo e($config->meta_description ?? ''); ?></textarea>
                                        <div class="form-text">
                                            <span id="desc_count_<?php echo e($paginaKey); ?>">0</span>/160 caracteres
                                        </div>
                                    </div>
...
<?php echo $__env->make('dashboard.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\templats-link\resources\views/dashboard/head/index.blade.php ENDPATH**/ ?>