...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="<?php echo e(route('favicon', ['filename' => 'favicon-main.svg'])); ?>">
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?php echo e(route('dashboard.floating-buttons')); ?>" class="menu-item <?php echo e(request()->routeIs('dashboard.floating-buttons*') ? 'active' : ''); ?>">
                <i class="fas fa-mobile-alt"></i>
                Botões Flutuantes
            </a>
            
            <a href="<?php echo e(route('dashboard.blog')); ?>" class="menu-item <?php echo e(request()->routeIs('dashboard.blog*') ? 'active' : ''); ?>">
                <i class="fas fa-blog"></i>
                Blog
            </a>
            
            <a href="<?php echo e(route('dashboard.leads')); ?>" class="menu-item <?php echo e(request()->routeIs('dashboard.leads*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\Templats-link-templats-link\resources\views/dashboard/layouts/admin.blade.php ENDPATH**/ ?>