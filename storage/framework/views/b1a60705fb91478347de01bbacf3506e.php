  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-12 m-auto">
            ...
            <a href="<?php echo e(route('home')); ?>">Home <i class="fa-solid fa-angle-right"></i> <span>Our Service</span></a>
            </div>
        </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="service3-single-boxarea">
            <div class="icons">
              <img src="<?php echo e(asset('temas/finazze/assets/img/icons/service19.svg')); ?>"" alt="">
            </div>
            <div class="space24"></div>
            <div class="content">
              <a href="service-single.html">Debt Restructuring Services</a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service3-single-boxarea">
            <div class="icons">
              <img src="<?php echo e(asset('temas/finazze/assets/img/icons/service20.svg')); ?>"" alt="">
            </div>
            <div class="space24"></div>
            <div class="content">
              <a href="service-single.html">Financial Strategy & Advisory</a>
              <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service3-single-boxarea">
            <div class="icons">
              <img src="<?php echo e(asset('temas/finazze/assets/img/icons/service21.svg')); ?>"" alt="">
            </div>
            <div class="space24"></div>
            <div class="content">
              <a href="service-single.html">Tax Planning & Compliance</a>
              <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service3-single-boxarea">
            <div class="icons">
              <img src="<?php echo e(asset('temas/finazze/assets/img/icons/service22.svg')); ?>"" alt="">
            </div>
            <div class="space24"></div>
            <div class="content">
              <a href="service-single.html">Risk Management & Mitigation</a>
              <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service3-single-boxarea">
            <div class="icons">
              <img src="<?php echo e(asset('temas/finazze/assets/img/icons/service23.svg')); ?>"" alt="">
            </div>
            <div class="space24"></div>
            <div class="content">
              <a href="service-single.html">Business Growth Planning</a>
              <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service3-single-boxarea">
            <div class="icons">
              <img src="<?php echo e(asset('temas/finazze/assets/img/icons/service24.svg')); ?>"" alt="">
            </div>
            <div class="space24"></div>
            <div class="content">
              <a href="service-single.html">Cash Flow Optimization</a>
              <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="service3-single-boxarea">
              <div class="icons">
                <img src="<?php echo e(asset('temas/finazze/assets/img/icons/service25.svg')); ?>"" alt="">
              </div>
              <div class="space24"></div>
              <div class="content">
                <a href="service-single.html">Cash Flow Optimization</a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service3-single-boxarea">
              <div class="icons">
                <img src="<?php echo e(asset('temas/finazze/assets/img/icons/service26.svg')); ?>"" alt="">
              </div>
              <div class="space24"></div>
              <div class="content">
                <a href="service-single.html">Corporate Finance Advisory</a>
                <div class="space16"></div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service3-single-boxarea">
              <div class="icons">
                <img src="<?php echo e(asset('temas/finazze/assets/img/icons/service27.svg')); ?>"" alt="">
              </div>
              <div class="space24"></div>
              <div class="content">
...
<?php echo $__env->make('temas.finazze.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\templats-link\resources\views/temas/finazze/service.blade.php ENDPATH**/ ?>