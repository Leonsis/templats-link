                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control" id="facebook" name="facebook" value="<?php echo e($navbarConfigs->facebook ?? ''); ?>" placeholder="https://facebook.com/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control" id="instagram" name="instagram" value="<?php echo e($navbarConfigs->instagram ?? ''); ?>" placeholder="https://instagram.com/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control" id="twitter" name="twitter" value="<?php echo e($navbarConfigs->twitter ?? ''); ?>" placeholder="https://twitter.com/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control" id="linkedin" name="linkedin" value="<?php echo e($navbarConfigs->linkedin ?? ''); ?>" placeholder="https://linkedin.com/company/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control"  id="youtube" name="youtube" value="<?php echo e($navbarConfigs->youtube ?? ''); ?>" placeholder="https://youtube.com/c/empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control"  id="github" name="github" value="<?php echo e($navbarConfigs->github ?? ''); ?>" placeholder="https://github.com/empresa">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('dashboard.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Templats-link-templats-link\resources\views/dashboard/navbar/index.blade.php ENDPATH**/ ?>