...
<?php $__env->startSection('title', 'Botões Flutuantes e Página de Contato'); ?>

<?php $__env->startSection('page-title', 'Botões Flutuantes e Página de Contato'); ?>
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0 text-gray-800">
                    ...
                    Configurações dos Botões Flutuantes e Página de Contato
                </h1>
            </div>
            ...
            <form action="<?php echo e(route('dashboard.floating-buttons.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="card shadow border-primary">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    <strong>Importante:</strong> Configure os números de telefone, WhatsApp e o email para onde os dados do formulário serão enviados.
                                </div>
                                ...
                                <div class="alert alert-warning alert-static" data-static="true">
                                    ...
                                    <code class="ms-2">@include('floatingButton.index')</code><br>
                                    <small class="text-muted">
                                        <strong>Exemplo de uso:</strong><br>
                                        &lt;!-- No footer do tema --&gt;<br>
                                        @include('floatingButton.index')<br>
                                        <strong>Nota:</strong> Esta tag deve ser colocada no footer do tema para exibir os botões flutuantes
                                    </small>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="telefone" 
                                                   name="telefone" 
                                                   value="<?php echo e($configs->telefone ?? ''); ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="whatsapp" 
                                                   name="whatsapp" 
                                                   value="<?php echo e($configs->whatsapp ?? ''); ?>"
                                                   placeholder="+55 (11) 99999-9999">
                                            <div class="form-text">
                                                <i class="fas fa-info-circle me-1"></i>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="email_formulario" class="form-label">
                                            ...
                                            <input type="email" 
                                                   ...
                                                   value="<?php echo e($configs->email_formulario ?? ''); ?>"
                                                   placeholder="contato@exemplo.com">
                                            <div class="form-text">
                                                <i class="fas fa-info-circle me-1"></i>
                                                Email para onde os dados do formulário de contato serão enviados.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fas fa-save me-2"></i>
                                 Salvar Configurações dos Botões Flutuantes e Página de Contato
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <h6><i class="fas fa-envelope text-info me-2"></i>Email Formulário:</h6>
                                    <ul class="list-unstyled">
                                        <li>• Email válido obrigatório</li>
                                        <li>• Exemplo: contato@exemplo.com</li>
                                        <li>• Receberá os dados do formulário</li>
                                        <li>• Usado para envio de leads</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('dashboard.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Templats-link-templats-link\resources\views/dashboard/floating-buttons/index.blade.php ENDPATH**/ ?>