<?php $__env->startSection('title', 'Home - Templats-link'); ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="d-flex gap-3">
                    <a href="<?php echo e(route('sobre')); ?>" class="btn btn-light btn-lg">
                        <i class="fas fa-info-circle me-2"></i>Saiba Mais
                    </a>
                    <a href="<?php echo e(route('contato')); ?>" class="btn btn-outline-light btn-lg">
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-12">
                ...
                <a href="<?php echo e(route('contato')); ?>" class="btn btn-primary btn-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/templats-link/resources/views/home.blade.php ENDPATH**/ ?>